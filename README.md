...
Some of the arenas and the exercises have been modified for the Research Track I course by professor Carmine Recchiuto, Unige. 
...
These features can be found in Prof. Recchiuto's Docker Image `carms84/noetic_ros2` used for this assignment. 
